# https://github.com/facebookresearch/InterHand2.6M/blob/2b8061d2c8e762aa6fcb8e6f5d18f8a9e83bfd0c/main/model.py
...
class Model(nn.Module):
    ...
    def render_gaussian_heatmap(self, joint_coord):
        ...
        z = torch.arange(cfg.output_hm_shape[0]) # z 없애면 2d 사용
